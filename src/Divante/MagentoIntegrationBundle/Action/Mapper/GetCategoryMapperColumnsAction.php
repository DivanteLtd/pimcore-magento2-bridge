...
/**
 * @Route("/object-mapper/get-columns-category", methods={"GET"})
 */
class GetCategoryMapperColumnsAction
{
    ...
    public function __invoke(Request $request): JsonResponse
    {
        return $this->responder->createResponse(
            $this->domain->getColumnsForClass($request->get('configurationId'), 'category')
        );
    }
}
