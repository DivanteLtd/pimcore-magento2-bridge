...
use Divante\MagentoIntegrationBundle\Domain\Provider\MagentoRestOutputProvider;
...
class RestClient
{
     ...
     */
    public function sendProduct(AbstractElement $object)
    {
