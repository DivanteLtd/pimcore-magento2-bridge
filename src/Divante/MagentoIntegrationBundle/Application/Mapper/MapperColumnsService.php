...
class MapperColumnsService
{
    ...
    protected function getMappingForMapElement($mapElement)
    {
        ...
        return [
            ...
            'searchable' => $mapElement[4] ?? null,
            'filterable' => $mapElement[5] ?? null,
            'comparable' => $mapElement[6] ?? null,
            'visible_on_front' => $mapElement[7] ?? null,
            'used_in_product_listing' => $mapElement[8] ?? null,
