...
pimcore.registerNS('pimcore.plugin.MagentoIntegrationBundle.item');
pimcore.plugin.MagentoIntegrationBundle.item = Class.create({
                ...
                success: function (response) {
                    try {
                        ...
                        if (res.success) {
                            ...
                            pimcore.helpers.showNotification(t('error'), t('save_error'),
                                'error', res.message);
                        }
                    } catch (e) {
